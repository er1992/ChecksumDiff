**ChecksumDiff** is an application that allows for comparison of the content of two revisions of a folder and generating the difference between the two revisions.
